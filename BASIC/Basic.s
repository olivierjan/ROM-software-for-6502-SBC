...
TK_INPUT          = $84       ; INPUT token
TK_DIM            = $85      ; DIM token
TK_READ           = $86        ; READ token
TK_LET            = $87       ; LET token
TK_DEC            = $88        ; DEC token
...
TK_RETIRQ         = $8E      ; RETIRQ token
TK_RETNMI         = $8F     ; RETNMI token
TK_RETURN         = $90     ; RETURN token
TK_REM            = $91     ; REM token
TK_STOP           = $92       ; STOP token
TK_ON             = $93 ; TK_STOP+1       ; ON token
TK_NULL           = $94 ; TK_ON+1         ; NULL token
TK_INC            = $95 ; TK_NULL+1       ; INC token
TK_WAIT           = $96  ;TK_INC+1        ; WAIT token
TK_LOAD           = $97  ;TK_WAIT+1       ; LOAD token
TK_SAVE           = $98 ; TK_LOAD+1       ; SAVE token
TK_DEF            = $99 ;TK_SAVE+1       ; DEF token
TK_POKE           = $9A ;TK_DEF+1        ; POKE token
TK_DOKE           = $9B ; TK_POKE+1       ; DOKE token
TK_CALL           = $9C ; TK_DOKE+1       ; CALL token
TK_DO             = $9D ;TK_CALL+1       ; DO token
TK_LOOP           = $9E ; TK_DO+1         ; LOOP token
TK_PRINT          = $9F ; TK_LOOP+1       ; PRINT token
TK_CONT           = $A0 ; TK_PRINT+1      ; CONT token
TK_LIST           = $A1 ;TK_CONT+1       ; LIST token
TK_CLEAR          = $A2 ; TK_LIST+1       ; CLEAR token
TK_NEW            = $A3 ; TK_CLEAR+1      ; NEW token
TK_WIDTH          = $A4 ; TK_NEW+1        ; WIDTH token
TK_GET            = $A5 ; TK_WIDTH+1      ; GET token
TK_SWAP           = $A6 ; TK_GET+1        ; SWAP token
TK_BITSET         = $A7 ; TK_SWAP+1       ; BITSET token
TK_BITCLR         = $A8 ; TK_BITSET+1     ; BITCLR token
TK_IRQ            = $A9 ; TK_BITCLR+1     ; IRQ token
TK_NMI            = $AA ; TK_IRQ+1        ; NMI token

; secondary command tokens, can't start a statement

TK_TAB            = $AB ; TK_NMI+1        ; TAB token
TK_ELSE           = $AC ;TK_TAB+1        ; ELSE token
TK_TO             = $AD ;TK_ELSE+1       ; TO token
TK_FN             = $AE ; TK_TO+1         ; FN token
TK_SPC            = $AF ; TK_FN+1         ; SPC token
TK_THEN           = $B0 ; TK_SPC+1        ; THEN token
TK_NOT            = $B1 ; TK_THEN+1       ; NOT token
TK_STEP           = $B2 ; TK_NOT+1        ; STEP token
TK_UNTIL          = $B3 ; TK_STEP+1       ; UNTIL token
TK_WHILE          = $B4 ; TK_UNTIL+1      ; WHILE token
TK_OFF            = $B5 ; TK_WHILE+1      ; OFF token

; opperator tokens

TK_PLUS           = $B6 ; TK_OFF+1        ; + token
TK_MINUS          = $B7 ; TK_PLUS+1       ; - token
TK_MUL            = $B8 ; TK_MINUS+1      ; * token
TK_DIV            = $B9 ; TK_MUL+1        ; / token
TK_POWER          = $BA ; TK_DIV+1        ; ^ token
TK_AND            = $BB ; TK_POWER+1      ; AND token
TK_EOR            = $BC ; TK_AND+1        ; EOR token
TK_OR             = $BD ;TK_EOR+1        ; OR token
TK_RSHIFT         = $BE ; TK_OR+1         ; RSHIFT token
TK_LSHIFT         = $BF ; TK_RSHIFT+1     ; LSHIFT token
TK_GT             = $C0 ; TK_LSHIFT+1     ; > token
TK_EQUAL          = $C1 ; TK_GT+1         ; = token
TK_LT             = $C2 ; TK_EQUAL+1      ; < token

; functions tokens

TK_SGN            = $C3 ; TK_LT+1         ; SGN token
TK_INT            = $C4 ; TK_SGN+1        ; INT token
TK_ABS            = $C5 ; TK_INT+1        ; ABS token
TK_USR            = $C6 ; TK_ABS+1        ; USR token
TK_FRE            = $C7 ; TK_USR+1        ; FRE token
TK_POS            = $C8 ; TK_FRE+1        ; POS token
TK_SQR            = $C9 ; TK_POS+1        ; SQR token
TK_RND            = $CA ; TK_SQR+1        ; RND token
TK_LOG            = $CB ; TK_RND+1        ; LOG token
TK_EXP            = $CC ; TK_LOG+1        ; EXP token
TK_COS            = $CD ;TK_EXP+1        ; COS token
TK_SIN            = $CE ; TK_COS+1        ; SIN token
TK_TAN            = $CF ; TK_SIN+1        ; TAN token
TK_ATN            = $D0 ; TK_TAN+1        ; ATN token
TK_PEEK           = $D1 ; TK_ATN+1        ; PEEK token
TK_DEEK           = $D2 ; TK_PEEK+1       ; DEEK token
TK_SADD           = $D3 ; TK_DEEK+1       ; SADD token
TK_LEN            = $D4 ; TK_SADD+1       ; LEN token
TK_STRS           = $D5 ; TK_LEN+1        ; STR$ token
TK_VAL            = $D6 ;TK_STRS+1       ; VAL token
TK_ASC            = $D7 ;TK_VAL+1        ; ASC token
TK_UCASES         = $D8 ;TK_ASC+1        ; UCASE$ token
TK_LCASES         = $D9 ; TK_UCASES+1     ; LCASE$ token
TK_CHRS           = $DA ; TK_LCASES+1     ; CHR$ token
TK_HEXS           = $DB ; TK_CHRS+1       ; HEX$ token
TK_BINS           = $DC ; TK_HEXS+1       ; BIN$ token
TK_BITTST         = $DE ; TK_BINS+1       ; BITTST token
TK_MAX            = $DF ; TK_BITTST+1     ; MAX token
TK_MIN            = $E0 ; TK_MAX+1        ; MIN token
TK_PI             = $E1 ; TK_MIN+1        ; PI token
TK_TWOPI          = $E2 ;TK_PI+1         ; TWOPI token
TK_VPTR           = $E3 ; TK_TWOPI+1      ; VARPTR token
TK_LEFTS          = $E4 ;TK_VPTR+1       ; LEFT$ token
TK_RIGHTS         = $E5 ; TK_LEFTS+1      ; RIGHT$ token
TK_MIDS           = $E6 ;TK_RIGHTS+1     ; MID$ token
...
LAB_16F4
      ...
      DB $2C               ; makes next line BIT LAB_0EA2
...
LAB_SNBS
      ...
      ;DB $2C               ; makes next line BIT $00A2
      DB    $2C
...
LAB_DEC
      ...
      ;DB $2C               ; BIT abs to skip the LDA below
      DB    $2C
...
LAB_18E0
      LDA   #$20              ; load ' '
      DB $2C               ; change next line to BIT LAB_3FA9
...
LAB_1E85
      ...
      DB $2C               ; makes next bit BIT LAB_08A2
...
LAB_2675
      ...
      DB $2C               ; makes next line BIT $1410
LAB_2680
...
PG2_TABS
      DB $00               ; ctrl-c flag           -     $00 = enabled
      DB $00               ; ctrl-c byte           -     GET needs this
      DB $00               ; ctrl-c byte timeout   -     GET needs this
      DW CTRLC             ; ctrl c check vector
;     DW xxxx              ; non halting key input -     monitor to set this
;     DW xxxx              ; output vector         -     monitor to set this
;     DW xxxx              ; load vector           -     monitor to set this
;     DW xxxx              ; save vector           -     monitor to set this
PG2_TABE
...
StrTab
      DB $4C               ; JMP opcode
      DW LAB_COLD          ; initial warm start vector (cold start)

      DB $00               ; these bytes are not used by BASIC
      DW $0000             ; 
      DW $0000             ; 
      DW $0000             ; 

      DB $4C               ; JMP opcode
      DW LAB_FCER          ; initial user function vector ('Function call' error)
      DB $00               ; default NULL count
      DB $00               ; clear terminal position
      DB $00               ; default terminal width byte
      DB $F2               ; default limit for TAB = 14
      DW Ram_base          ; start of user RAM
EndTab

LAB_MSZM
      ASC $0D,$0A,'Memory size ',$00

LAB_SMSG
      ASC ' Bytes free',$0D,$0A,$0A
      ASC 'Enhanced BASIC 2.22p4',$0A,$00
...
LAB_25A0
      DB $02               ; counter
      DB $80,$19,$56,$62   ; 0.59898
      DB $80,$76,$22,$F3   ; 0.96147
;##   DB $80,$76,$22,$F1   ; 0.96147
      DB $82,$38,$AA,$40   ; 2.88539
;##   DB $82,$38,$AA,$45   ; 2.88539

LAB_25AD
      DB $80,$35,$04,$F3   ; 0.70711   1/root 2
LAB_25B1
      DB $81,$35,$04,$F3   ; 1.41421   root 2
LAB_25B5
      DB $80,$80,$00,$00   ; -0.5
LAB_25B9
      DB $80,$31,$72,$18   ; 0.69315   LOG(2)

                              ; numeric PRINT constants
LAB_2947
      DB $91,$43,$4F,$F8   ; 99999.9375 (max value with at least one decimal)
LAB_294B
      DB $94,$74,$23,$F7   ; 999999.4375 (max value before scientific notation)
LAB_294F
      DB $94,$74,$24,$00   ; 1000000

                              ; EXP(n) constants and series
LAB_2AFA
      DB $81,$38,$AA,$3B   ; 1.4427    (1/LOG base 2 e)
LAB_2AFE
      DB $06               ; counter
      DB $74,$63,$90,$8C   ; 2.17023e-4
      DB $77,$23,$0C,$AB   ; 0.00124
      DB $7A,$1E,$94,$00   ; 0.00968
      DB $7C,$63,$42,$80   ; 0.05548
      DB $7E,$75,$FE,$D0   ; 0.24023
      DB $80,$31,$72,$15   ; 0.69315
      DB $81,$00,$00,$00   ; 1.00000

;##   DB $07               ; counter
;##   DB $74,$94,$2E,$40   ; -1/7! (-1/5040)
;##   DB $77,$2E,$4F,$70   ;  1/6! ( 1/720)
;##   DB $7A,$88,$02,$6E   ; -1/5! (-1/120)
;##   DB $7C,$2A,$A0,$E6   ;  1/4! ( 1/24)
;##   DB $7E,$AA,$AA,$50   ; -1/3! (-1/6)
;##   DB $7F,$7F,$FF,$FF   ;  1/2! ( 1/2)
;##   DB $81,$80,$00,$00   ; -1/1! (-1/1)
;##   DB $81,$00,$00,$00   ;  1/0! ( 1/1)

                              ; trigonometric constants and series
LAB_2C78
      DB $81,$49,$0F,$DB   ; 1.570796371 (pi/2) as floating #
LAB_2C84
      DB $04               ; counter
      DB $86,$1E,$D7,$FB   ; 39.7109
;##   DB $86,$1E,$D7,$BA   ; 39.7109
      DB $87,$99,$26,$65   ;-76.575
;##   DB $87,$99,$26,$64   ;-76.575
      DB $87,$23,$34,$58   ; 81.6022
      DB $86,$A5,$5D,$E1   ;-41.3417
;##   DB $86,$A5,$5D,$E0   ;-41.3417
LAB_2C7C
      DB $83,$49,$0F,$DB   ; 6.28319 (2*pi) as floating #
;##   DB $83,$49,$0F,$DA   ; 6.28319 (2*pi) as floating #

LAB_2CC9
      DB $08               ; counter
      DB $78,$3A,$C5,$37   ; 0.00285
      DB $7B,$83,$A2,$5C   ;-0.0160686
      DB $7C,$2E,$DD,$4D   ; 0.0426915
      DB $7D,$99,$B0,$1E   ;-0.0750429
      DB $7D,$59,$ED,$24   ; 0.106409
      DB $7E,$91,$72,$00   ;-0.142036
      DB $7E,$4C,$B9,$73   ; 0.199926
      DB $7F,$AA,$AA,$53   ;-0.333331
...
LAB_259C
      DB $81,$00,$00,$00   ; 1.000000, used for INC
LAB_2AFD
      DB $81,$80,$00,$00   ; -1.00000, used for DEC. must be on the same page as +1.00

                              ; misc constants
LAB_1DF7
      DB $90               ;-32768 (uses first three bytes from 0.5)
LAB_2A96
      DB $80,$00,$00,$00   ; 0.5
LAB_2C80
      DB $7F,$00,$00,$00   ; 0.25
LAB_26B5
      DB $84,$20,$00,$00   ; 10.0000 divide by 10 constant
...
LAB_CTBL
      ...
      DW LAB_NEXT-1        ; NEXT
      DW LAB_DATA-1        ; DATA
      DW LAB_INPUT-1       ; INPUT
      DW LAB_DIM-1         ; DIM
      DW LAB_READ-1        ; READ
      DW LAB_LET-1         ; LET
      DW LAB_DEC-1         ; DEC             new command
      DW LAB_GOTO-1        ; GOTO
      DW LAB_RUN-1         ; RUN
      DW LAB_IF-1          ; IF
      DW LAB_RESTORE-1     ; RESTORE         modified command
      DW LAB_GOSUB-1       ; GOSUB
      DW LAB_RETIRQ-1      ; RETIRQ          new command
      DW LAB_RETNMI-1      ; RETNMI          new command
      DW LAB_RETURN-1      ; RETURN
      DW LAB_REM-1         ; REM
      DW LAB_STOP-1        ; STOP
      DW LAB_ON-1          ; ON              modified command
      DW LAB_NULL-1        ; NULL            modified command
      DW LAB_INC-1         ; INC             new command
      DW LAB_WAIT-1        ; WAIT
      DW V_LOAD-1          ; LOAD
      DW V_SAVE-1          ; SAVE
      DW LAB_DEF-1         ; DEF
      DW LAB_POKE-1        ; POKE
      DW LAB_DOKE-1        ; DOKE            new command
      DW LAB_CALL-1        ; CALL            new command
      DW LAB_DO-1          ; DO              new command
      DW LAB_LOOP-1        ; LOOP            new command
      DW LAB_PRINT-1       ; PRINT
      DW LAB_CONT-1        ; CONT
      DW LAB_LIST-1        ; LIST
      DW LAB_CLEAR-1       ; CLEAR
      DW LAB_NEW-1         ; NEW
      DW LAB_WDTH-1        ; WIDTH           new command
      DW LAB_GET-1         ; GET             new command
      DW LAB_SWAP-1        ; SWAP            new command
      DW LAB_BITSET-1      ; BITSET          new command
      DW LAB_BITCLR-1      ; BITCLR          new command
      DW LAB_IRQ-1         ; IRQ             new command
      DW LAB_NMI-1         ; NMI             new command

; function pre process routine table

LAB_FTPL
LAB_FTPM    = LAB_FTPL+$01
      DW LAB_PPFN-1        ; SGN(n)    process numeric expression in ()
      DW LAB_PPFN-1        ; INT(n)          '
      DW LAB_PPFN-1        ; ABS(n)          '
      DW LAB_EVEZ-1        ; USR(x)    process any expression
      DW LAB_1BF7-1        ; FRE(x)          '
      DW LAB_1BF7-1        ; POS(x)          '
      DW LAB_PPFN-1        ; SQR(n)    process numeric expression in ()
      DW LAB_PPFN-1        ; RND(n)          '
      DW LAB_PPFN-1        ; LOG(n)          '
      DW LAB_PPFN-1        ; EXP(n)          '
      DW LAB_PPFN-1        ; COS(n)          '
      ...
      DW LAB_PPFN-1        ; TAN(n)          '
      DW LAB_PPFN-1        ; ATN(n)          '
      DW LAB_PPFN-1        ; PEEK(n)         '
      DW LAB_PPFN-1        ; DEEK(n)         '
      DW $0000             ; SADD()    none
      DW LAB_PPFS-1        ; LEN($)    process string expression in ()
      DW LAB_PPFN-1        ; STR$(n)   process numeric expression in ()
      DW LAB_PPFS-1        ; VAL($)    process string expression in ()
      DW LAB_PPFS-1        ; ASC($)          '
      DW LAB_PPFS-1        ; UCASE$($)       '
      DW LAB_PPFS-1        ; LCASE$($)       '
      DW LAB_PPFN-1        ; CHR$(n)   process numeric expression in ()
      DW LAB_BHSS-1        ; HEX$(n)         '
      DW LAB_BHSS-1        ; BIN$(n)         '
      DW $0000             ; BITTST()  none
      DW LAB_MMPP-1        ; MAX()     process numeric expression
      DW LAB_MMPP-1        ; MIN()           '
      DW LAB_PPBI-1        ; PI        advance pointer
      DW LAB_PPBI-1        ; TWOPI           '
      DW $0000             ; VARPTR()  none
      DW LAB_LRMS-1        ; LEFT$()   process string expression
      DW LAB_LRMS-1        ; RIGHT$()        '
      DW LAB_LRMS-1        ; MID$()          '
...
LAB_FTBM    = LAB_FTBL+$01
      ...
      DW LAB_POS-1         ; POS()
      DW LAB_SQR-1         ; SQR()
      DW LAB_RND-1         ; RND()           modified function
      DW LAB_LOG-1         ; LOG()
      DW LAB_EXP-1         ; EXP()
      DW LAB_COS-1         ; COS()
      DW LAB_SIN-1         ; SIN()
      ...
      DW LAB_ATN-1         ; ATN()
      DW LAB_PEEK-1        ; PEEK()
      DW LAB_DEEK-1        ; DEEK()          new function
      DW LAB_SADD-1        ; SADD()          new function
      DW LAB_LENS-1        ; LEN()
      DW LAB_STRS-1        ; STR$()
      DW LAB_VAL-1         ; VAL()
      DW LAB_ASC-1         ; ASC()
      DW LAB_UCASE-1       ; UCASE$()        new function
      DW LAB_LCASE-1       ; LCASE$()        new function
      DW LAB_CHRS-1        ; CHR$()
      DW LAB_HEXS-1        ; HEX$()          new function
      DW LAB_BINS-1        ; BIN$()          new function
      DW LAB_BTST-1        ; BITTST()        new function
      DW LAB_MAX-1         ; MAX()           new function
      DW LAB_MIN-1         ; MIN()           new function
      DW LAB_PI-1          ; PI              new function
      DW LAB_TWOPI-1       ; TWOPI           new function
      DW LAB_VARPTR-1      ; VARPTR()        new function
      DW LAB_LEFT-1        ; LEFT$()
      DW LAB_RIGHT-1       ; RIGHT$()
      DW LAB_MIDS-1        ; MID$()
...
TAB_CHRT
      DW TAB_STAR          ; table for '*'
      DW TAB_PLUS          ; table for '+'
      DW TAB_MNUS          ; table for '-'
      DW TAB_SLAS          ; table for '/'
      DW TAB_LESS          ; table for '<'
      DW TAB_EQUL          ; table for '='
      DW TAB_MORE          ; table for '>'
      DW TAB_QEST          ; table for '?'
      DW TAB_ASCA          ; table for 'A'
      DW TAB_ASCB          ; table for 'B'
      DW TAB_ASCC          ; table for 'C'
      DW TAB_ASCD          ; table for 'D'
      DW TAB_ASCE          ; table for 'E'
      DW TAB_ASCF          ; table for 'F'
      DW TAB_ASCG          ; table for 'G'
      DW TAB_ASCH          ; table for 'H'
      DW TAB_ASCI          ; table for 'I'
      DW TAB_ASCL          ; table for 'L'
      DW TAB_ASCM          ; table for 'M'
      DW TAB_ASCN          ; table for 'N'
      DW TAB_ASCO          ; table for 'O'
      DW TAB_ASCP          ; table for 'P'
      DW TAB_ASCR          ; table for 'R'
      DW TAB_ASCS          ; table for 'S'
      DW TAB_ASCT          ; table for 'T'
      DW TAB_ASCU          ; table for 'U'
      DW TAB_ASCV          ; table for 'V'
      DW TAB_ASCW          ; table for 'W'
      DW TAB_POWR          ; table for '^'
...
TAB_LESS
LBB_LSHIFT
      DB '<',TK_LSHIFT     ; <<  note - '<<' must come before '<'
      DB TK_LT             ; <
      DB $00
TAB_EQUL
      DB TK_EQUAL,$00      ; =
TAB_MORE
LBB_RSHIFT
      DB '>',TK_RSHIFT     ; >>  note - '>>' must come before '>'
      DB TK_GT             ; >
      DB $00
TAB_QEST
      DB TK_PRINT,$00      ; ?
...
LBB_BINS
      ASC 'IN$(',TK_BINS    ; BIN$(
LBB_BITCLR
      ASC 'ITCLR',TK_BITCLR ; BITCLR
LBB_BITSET
      ASC 'ITSET',TK_BITSET ; BITSET
LBB_BITTST
      ASC 'ITTST(',TK_BITTST
                              ; BITTST(
      ASC $00
TAB_ASCC
LBB_CALL
      ASC 'ALL',TK_CALL     ; CALL
LBB_CHRS
      ASC 'HR$(',TK_CHRS    ; CHR$(
LBB_CLEAR
      ASC 'LEAR',TK_CLEAR   ; CLEAR
LBB_CONT
      ASC 'ONT',TK_CONT     ; CONT
LBB_COS
      ASC 'OS(',TK_COS      ; COS(
      ASC $00
TAB_ASCD
LBB_DATA
      ASC 'ATA',TK_DATA     ; DATA
LBB_DEC
      ASC 'EC',TK_DEC       ; DEC
LBB_DEEK
      ASC 'EEK(',TK_DEEK    ; DEEK(
LBB_DEF
      ASC 'EF',TK_DEF       ; DEF
LBB_DIM
      ASC 'IM',TK_DIM       ; DIM
LBB_DOKE
      ASC 'OKE',TK_DOKE     ; DOKE note - 'DOKE' must come before 'DO'
LBB_DO
      ASC 'O',TK_DO         ; DO
      ASC $00
TAB_ASCE
LBB_ELSE
      ASC 'LSE',TK_ELSE     ; ELSE
LBB_END
      ASC 'ND',TK_END       ; END
LBB_EOR
      ASC 'OR',TK_EOR       ; EOR
...
LBB_GET
      ASC 'ET',TK_GET       ; GET
LBB_GOSUB
      ASC 'OSUB',TK_GOSUB   ; GOSUB
LBB_GOTO
      ASC 'OTO',TK_GOTO     ; GOTO
      ASC $00
TAB_ASCH
LBB_HEXS
      ASC 'EX$(',TK_HEXS    ; HEX$(
...
LBB_LCASES
      ASC 'CASE$(',TK_LCASES
                              ; LCASE$(
LBB_LEFTS
      ASC 'EFT$(',TK_LEFTS  ; LEFT$(
LBB_LEN
      ASC 'EN(',TK_LEN      ; LEN(
LBB_LET
      ASC 'ET',TK_LET       ; LET
LBB_LIST
      ASC 'IST',TK_LIST     ; LIST
LBB_LOAD
      ASC 'OAD',TK_LOAD     ; LOAD
LBB_LOG
      ASC 'OG(',TK_LOG      ; LOG(
LBB_LOOP
      ASC 'OOP',TK_LOOP     ; LOOP
      ASC $00
TAB_ASCM
LBB_MAX
      ASC 'AX(',TK_MAX      ; MAX(
...
LBB_NEW
      ASC 'EW',TK_NEW       ; NEW
LBB_NEXT
      ASC 'EXT',TK_NEXT     ; NEXT
LBB_NMI
      ASC 'MI',TK_NMI       ; NMI
LBB_NOT
      ASC 'OT',TK_NOT       ; NOT
LBB_NULL
      ASC 'ULL',TK_NULL     ; NULL
      ASC $00
TAB_ASCO
LBB_OFF
      ASC 'FF',TK_OFF       ; OFF
...
TAB_ASCP
LBB_PEEK
      ASC 'EEK(',TK_PEEK    ; PEEK(
LBB_PI
      ASC 'I',TK_PI         ; PI
LBB_POKE
      ASC 'OKE',TK_POKE     ; POKE
LBB_POS
      ASC 'OS(',TK_POS      ; POS(
LBB_PRINT
      ASC 'RINT',TK_PRINT   ; PRINT
      ASC $00
TAB_ASCR
LBB_READ
      ASC 'EAD',TK_READ     ; READ
LBB_REM
      ASC 'EM',TK_REM       ; REM
LBB_RESTORE
      ASC 'ESTORE',TK_RESTORE
                              ; RESTORE
LBB_RETIRQ
      ASC 'ETIRQ',TK_RETIRQ ; RETIRQ
LBB_RETNMI
      ASC 'ETNMI',TK_RETNMI ; RETNMI
LBB_RETURN
      ASC 'ETURN',TK_RETURN ; RETURN
LBB_RIGHTS
      ASC 'IGHT$(',TK_RIGHTS
                              ; RIGHT$(
LBB_RND
...
TAB_ASCS
LBB_SADD
      ASC 'ADD(',TK_SADD    ; SADD(
LBB_SAVE
      ASC 'AVE',TK_SAVE     ; SAVE
LBB_SGN
      ASC 'GN(',TK_SGN      ; SGN(
LBB_SIN
      ASC 'IN(',TK_SIN      ; SIN(
...
LBB_SQR
      ASC 'QR(',TK_SQR      ; SQR(
LBB_STEP
      ASC 'TEP',TK_STEP     ; STEP
LBB_STOP
      ASC 'TOP',TK_STOP     ; STOP
LBB_STRS
      ASC 'TR$(',TK_STRS    ; STR$(
LBB_SWAP
      ASC 'WAP',TK_SWAP     ; SWAP
      ASC $00
TAB_ASCT
LBB_TAB
      ASC 'AB(',TK_TAB      ; TAB(
LBB_TAN
      ASC 'AN(',TK_TAN      ; TAN(
LBB_THEN
      ASC 'HEN',TK_THEN     ; THEN
LBB_TO
      ASC 'O',TK_TO         ; TO
LBB_TWOPI
      ASC 'WOPI',TK_TWOPI   ; TWOPI
      ASC $00
TAB_ASCU
LBB_UCASES
      ASC 'CASE$(',TK_UCASES
...
LBB_VAL
      ASC 'AL(',TK_VAL      ; VAL(
LBB_VPTR
      ASC 'ARPTR(',TK_VPTR  ; VARPTR(
      ASC $00
TAB_ASCW
LBB_WAIT
      ASC 'AIT',TK_WAIT     ; WAIT
LBB_WHILE
      ASC 'HILE',TK_WHILE   ; WHILE
LBB_WIDTH
      ASC 'IDTH',TK_WIDTH   ; WIDTH
      ASC $00
TAB_POWR
      ASC TK_POWER,$00      ; ^
...
LAB_KEYT
      ...
      DW LBB_IF            ; IF
      DB 7,'R'
      DW LBB_RESTORE       ; RESTORE
      DB 5,'G'
      DW LBB_GOSUB         ; GOSUB
      DB 6,'R'
      DW LBB_RETIRQ        ; RETIRQ
      DB 6,'R'
      DW LBB_RETNMI        ; RETNMI
      DB 6,'R'
      DW LBB_RETURN        ; RETURN
      DB 3,'R'
      DW LBB_REM           ; REM
      DB 4,'S'
      DW LBB_STOP          ; STOP
      ...
      DW LBB_SWAP          ; SWAP
      DB 6,'B'
      DW LBB_BITSET        ; BITSET
      DB 6,'B'
      DW LBB_BITCLR        ; BITCLR
      DB 3,'I'
      DW LBB_IRQ           ; IRQ
      DB 3,'N'
      DW LBB_NMI           ; NMI
...
LAB_BAER
      DW ERR_NF            ;$00 NEXT without FOR
      DW ERR_SN            ;$02 syntax
      DW ERR_RG            ;$04 RETURN without GOSUB
      DW ERR_OD            ;$06 out of data
      DW ERR_FC            ;$08 function call
      DW ERR_OV            ;$0A overflow
      DW ERR_OM            ;$0C out of memory
      DW ERR_US            ;$0E undefined statement
      DW ERR_BS            ;$10 array bounds
      DW ERR_DD            ;$12 double dimension array
      DW ERR_D0            ;$14 divide by 0
      DW ERR_ID            ;$16 illegal direct
      DW ERR_TM            ;$18 type mismatch
      DW ERR_LS            ;$1A long string
      DW ERR_ST            ;$1C string too complex
      DW ERR_CN            ;$1E continue error
      DW ERR_UF            ;$20 undefined function
      DW ERR_LD            ;$22 LOOP without DO

; I may implement these two errors to force definition of variables and
; dimensioning of arrays before use.

;     DW ERR_UV            ;$24 undefined variable

; the above error has been tested and works (see code and comments below LAB_1D8B)

;     DW ERR_UA            ;$26 undimensioned array

ERR_NF      ASC 'NEXT without FOR',$00
ERR_SN      ASC 'Syntax',$00
ERR_RG      ASC 'RETURN without GOSUB',$00
ERR_OD      ASC 'Out of DATA',$00
ERR_FC      ASC 'Function call',$00
ERR_OV      ASC 'Overflow',$00
ERR_OM      ASC 'Out of memory',$00
ERR_US      ASC 'Undefined statement',$00
ERR_BS      ASC 'Array bounds',$00
ERR_DD      ASC 'Double dimension',$00
ERR_D0      ASC 'Divide by zero',$00
ERR_ID      ASC 'Illegal direct',$00
ERR_TM      ASC 'Type mismatch',$00
ERR_LS      ASC 'String too long',$00
ERR_ST      ASC 'String too complex',$00
ERR_CN      ASC 'Can',$27,'t continue',$00
ERR_UF      ASC 'Undefined function',$00
ERR_LD      ASC 'LOOP without DO',$00

;ERR_UV     DB 'Undefined variable',$00

; the above error has been tested and works (see code and comments below LAB_1D8B)

;ERR_UA     DB 'Undimensioned array',$00

LAB_BMSG    ASC $0D,$0A,'Break',$00
LAB_EMSG    ASC ' Error',$00
LAB_LMSG    ASC ' in line ',$00
LAB_RMSG    ASC $0D,$0A,'Ready',$0D,$0A,$00

LAB_IMSG    ASC ' Extra ignored',$0D,$0A,$00
LAB_REDO    ASC ' Redo from start',$0D,$0A,$00
